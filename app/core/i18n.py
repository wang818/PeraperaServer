...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "email_captcha_body": {
        "en": "Your verification code is: {captcha}",
        "ar": "رمز التحقق الخاص بك هو: {captcha}",
        "de": "Ihr Bestätigungscode lautet: {captcha}",
        "es": "Su código de verificación es: {captcha}",
        "fil": "Ang iyong code ng pagpapatunay ay: {captcha}",
        "fr": "Votre code de vérification est: {captcha}",
        "id": "Kode verifikasi Anda adalah: {captcha}",
        "ja": "認証コードは: {captcha}",
        "ko": "인증 코드는: {captcha}",
        "ms": "Kod pengesahan anda ialah: {captcha}",
        "my": "သင်၏ အတည်ပြုကုဒ်မှာ: {captcha}",
        "pl": "Twój kod weryfikacyjny to: {captcha}",
        "pt": "Seu código de verificação é: {captcha}",
        "ru": "Ваш код подтверждения: {captcha}",
        "th": "รหัสยืนยันของคุณคือ: {captcha}",
        "tr": "Doğrulama kodunuz: {captcha}",
        "vi": "Mã xác nhận của bạn là: {captcha}",
        "zh-CN": "您的验证码是: {captcha}",
        "zh-Hant": "您的驗證碼是: {captcha}"
    },
